...

  {
    ...
    config = function()
      require('flutter-tools').setup {
        ...
        -- Or to configure widget guidelines:
        widget_guides = {
          enabled = true,
        },
      }
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        --     -- Keybindings and other on_attach functions
        --     require('flutter-tools.lsp').on_attach(client, bufnr) -- Integrate flutter-tools on_attach
        --   end,
        -- },
        gopls = {
          cmd = { 'gopls' },
